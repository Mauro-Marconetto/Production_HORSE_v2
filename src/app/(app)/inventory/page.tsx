        ...
        <main className="flex flex-1 flex-col gap-4 p-4 md:gap-8 md:p-8">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Resumen de todas las piezas en inventario, diferenciando entre stock listo y sin prensar. Los niveles Mín/Máx se configuran en el catálogo de piezas.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Table>
                        <TableHeader>
